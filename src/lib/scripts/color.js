...
export class Color {
    ...
    /**
     * Create a Color from HSB (HSV) values, as used in Adobe apps.
     * @param {number} h Hue in degrees (0–360, wraps)
     * @param {number} s Saturation 0–100
    ...
    /**
     * Get HSB (HSV) values, as used in Adobe apps.
